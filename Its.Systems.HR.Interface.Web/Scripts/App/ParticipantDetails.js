                    ...
                    success: function(result) {
                        if (result.Success) {
                            var html = '<tr><td><a href="' +
                                hr_urlPrefix +
                                "/ActivitySummary/SessionForActivity/" +
                                sessionId +
                                '">' +
                                result.SessionName +
                                "</a><span> (" +
                                result.StartDate +
                                ') </span><span class="label label-warning listedParticipantRemove js-delete-sessionParticipant" data-sessionId="' +
                                result.SessionId +
                                '" data-personId="' +
                                result.PersonId +
                                '">Ta bort</span></tr></td>';
